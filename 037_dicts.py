...
my_dictionary = {
  ...
  "Definition": " a list words with meanings, but in context of programming a dictionary is collection of keys mapped to values"
}
...
print("A Dictionary is:" + my_dictionary["Definition"])
# ...
